...
from vlm_wrappers.generate_prompt import generate_vlm_prompt__, gender_from_text, generate_vlm_prompt__2
...
def prompt_optimization_loop(method, config, factual_frame, f_prompt, crf_prompt, interv_type, max_epochs = 1):
    ...
    vlm_prompt = generate_vlm_prompt__2(crf_prompt, target_interventions)
   # print(vlm_prompt)
   ...
   # print(frames[10].shape)
    ...
    for i in range(max_epochs):
        ...
        loss_fn = ImageQALoss(
            ...
            5)Do not include age ranges(e.g. 20s, 70s, 80s etc), and numbers to describe age.
