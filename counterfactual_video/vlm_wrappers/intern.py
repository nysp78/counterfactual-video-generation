...
prompt_ = generate_vlm_prompt("bald", "yes", upstreams=upstream_attributes, all_attributes=all_attributes)

# Usage
#model = InternVL25_8B()
img_path = "/home/ubuntu/counterfactual-video-generation/counterfactual_video/outputs_v2/tokenflow-results_cfg_scale_4.5/explicit/interventions/age/-_B4fiuWwmo_0_1/He is old, he has beard, he is bald./vae_recon/00000.png"

#response = model.generate(img_path, "Describe this image:")
#print(response)
if __name__ == "__main__":
    ...
    response, history = vlm.chat(image_path, prompt_)
